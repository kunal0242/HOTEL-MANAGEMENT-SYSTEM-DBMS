    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            ...
            <ul class="nav navbar-top-links navbar-right" >
                <li class="dropdown">
                   <a class="dropdown-toggle" data-toggle="dropdown" href="usersetting.php" aria-expanded="false">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i> Room reservations</a>
                    </li>
                    <li>
                        <a href="payment.php"><i class="fa fa-qrcode"></i> Dues</a>
                    </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Status <small>Room reservation </small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 New Room Reservations  <span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Reserved rooms  <span class="badge"><?php echo $r ; ?></span>
											</button>
							...
							<div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Following <span class="badge"><?php echo $f ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Full name</th>
                                            <th>E-mail</th>
											<th>Began to follow</th>
                                            <th>Delegations Status</th>
